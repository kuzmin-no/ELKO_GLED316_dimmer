...
class FTPdLite:
    ...
    async def clear_all_sessions(self, search_value):
        """
    ...
    async def on_ctrl_connect(self, ctrl_reader, ctrl_writer):
        ...
        if (
            ...
            or await self.clear_all_sessions(client_ip) != []
        ):
    ...
    async def _memory(self):
        while True:
            ...
            gc_collect()
            self.debug("RAM free {} alloc {}".format( mem_free(), mem_alloc() ))
